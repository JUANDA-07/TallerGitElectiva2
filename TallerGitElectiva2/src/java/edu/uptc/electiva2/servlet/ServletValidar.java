...
public class ServletValidar extends HttpServlet {
    ...
    public ServletValidar() throws SQLException, IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServletValidar.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
